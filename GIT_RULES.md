...
쉬는 시간(매 시간 50분)을 git 동기화 타이밍으로 활용합니다.

```
09:00          작업 시작 전  →  git pull   (남이 올린 것 먼저 받기)
09:00~09:50    작업
09:50          쉬기 전       →  git push   (내 작업 올리기)
10:00          복귀 후       →  git pull   (쉬는 동안 올라온 것 받기)
10:00~10:50    작업
10:50          쉬기 전       →  git push
...반복...
17:50          퇴근 전       →  git push   (마무리 저장 필수)
```
...
작업 시작 전 팀 채팅에 **"나 오늘 app.py 작업할게"** 한 마디면 충돌의 90%를 막을 수 있습니다.
...
> **시작할 때 pull, 쉬기 전 push, 같은 파일은 미리 말하기**
